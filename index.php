	...
	<div class="slider blue-nav">
		<ul class="slides">
			...
			<li id="slide-1">
				...
				<!-- Background Image -->
				<img src="<?php echo ROOT_URL ?>images/back.jpeg" alt="slide-background">
						...
						<div class="row">
							<div class="col-md-9 col-lg-8">
								<div class="caption-txt">
									...
									<!-- Title -->
									<h2 class="white-color">Abşeron Rayon <span class="pink-color">Mərkəzi
											Xəstəxanası</span></h2>
									...
									<div class="box-list">
										...
										<p class="p-md white-color">Fringilla risus nec, luctus mauris orci auctor purus
											euismod
									...
									<div class="box-list">
										...
										<p class="p-md white-color">Feugiat primis ultrice in ligula risus auctor tempus
											feugiat impedit</p>
									</div>
									...
									<div class="box-list mb-15">
										...
										<p class="p-md white-color">Porta semper lacus cursus, feugiat primis ultrice in
											ligula risus
									...
									<!-- Button -->
									<a href="#" class="btn btn-blue blue-hover">Daha ətraflı</a>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="abox-4 mb-40 wow fadeInUp" data-wow-delay="0.4s">
					...
					<!-- Image -->
					<img class="img-fluid" src="<?php echo ROOT_URL ?>images/card1.jpg" alt="about-image" />

					<!-- Text -->
					<div class="abox-4-txt">

						<!-- Title -->
						<h5 class="h5-xs steelblue-color"><a href="#">Bir ömür xidmətinizdə
							</a>
						</h5>
			...
			<div class="col-lg-4">
				<div class="abox-4 mb-40 wow fadeInUp" data-wow-delay="0.6s">
					...
					<!-- Image -->
					<img class="img-fluid" src="<?php echo ROOT_URL ?>images/teciliyardim.jpg" alt="about-image" />

					<!-- Text -->
					<div class="abox-4-txt">

						<!-- Title -->
						<h5 class="h5-xs steelblue-color"><a href="#">Emergency Department</a>
						</h5>
			...
			<div class="col-lg-4">
				<div class="abox-4 abox-4-table blue-table mb-40 wow fadeInUp" data-wow-delay="0.6s">
					...
					<table class="table">
						<tbody>
							<tr>
								<td>Bazar Ertəsi – Cümə</td>
								<td> - </td>
								<td class="text-right">9:00 - 15:30 </td>
							</tr>
							<tr>
								<td>Şənbə</td>
								<td>-</td>
							...
							<tr class="last-tr">
								<td>Bazar</td>
								<td>-</td>
								<td class="text-right">Bağlıdır</td>
							</tr>
						</tbody>
					</table>
		...
		<div class="row d-flex align-items-center">
			...
			<div class="col-lg-6">
				<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
					...
					<!-- Title -->
					<h3 class="h3-md steelblue-color">Tibbi Ərazi Bölmələri
					</h3>
					...
					<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor tempus feugiat
						...
						integer
						metus mollis faucibus. An enim nullam tempor sapien gravida donec pretium and ipsum
						porta
					...
					<div class="singnature mt-35">
						...
						<img class="img-fluid" src="images/signature.png" width="200" height="34"
							alt="signature-image" />
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 section-title">
				...
				<!-- Title 	-->
				<h3 class="h3-md steelblue-color">Tibbi Bölmələrimiz
				</h3>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="0.4s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Poliklinika şöbəsi</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="0.6s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Cərrahiyyə şöbəsi</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="0.8s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Reanimasiya şöbəsi</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="1s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Şüa diaqnostikası</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="0.4s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Neyrotravma şöbəsi</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="0.6s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Fizioterapiya şöbəsi</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="0.8s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Laboratoriya şöbəsi</h5>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="sbox-2 wow fadeInUp" data-wow-delay="1s">
					<a href="#">
						...
						<!-- Title -->
						<h5 class="h5-sm sbox-2-title steelblue-color">Təcili yardım bölməsi</h5>
			...
			<div class="col-lg-6">
				<div class="txt-block pc-30 white-color wow fadeInUp" data-wow-delay="0.4s">
					...
					<p>An enim nullam tempor sapien gravida donec pretium ipsum porta justo integer at odio
						velna vitae auctor integer congue magna purus pretium ligula rutrum luctus ultrice
						aliquam
						a augue suscipit. Augue egestas volutpat egestas augue in cubilia laoreet magna
					</p>

					<!-- Button -->
					<a href="#" class="btn btn-tra-white white-hover mt-20">Find Out More</a>
	...
	<div class="row gallery-items-list">
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-1.jpg" title=""><i
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-2.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-3.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-4.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-5.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-6.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-7.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="col-md-6 col-lg-3 gallery-item">
			<div class="hover-overlay">
				...
				<!-- Image Zoom -->
				<div class="image-zoom">
					<a class="image-link" href="images/gallery/image-8.jpg" title=""><i
							class="fas fa-search-plus"></i></a>
				</div>
		...
		<div class="row d-flex align-items-center">
			...
			<div class="col-lg-6">
				<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
					...
					<!-- Title -->
					<h3 class="h3-md steelblue-color">Bir ömür xidmətinizdəyik</h3>
					...
					<div class="box-list">
						...
						<p>Maecenas gravida porttitor nunc, quis vehicula magna luctus tempor. Quisque vel
							laoreet
							turpis urna augue, viverra a augue eget, dictum tempor diam pulvinar massa purus
							nulla
						</p>
					</div>

					<!-- Button -->
					<a href="#" class="btn btn-blue blue-hover mt-25">Meet The Doctors</a>
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-3">
				<div class="statistic-block icon-sm wow fadeInUp" data-wow-delay="0.4s">
					...
					<p class="txt-400">Müraciət sayı</p>
			...
			<div class="col-md-6 col-lg-3">
				<div class="statistic-block icon-sm wow fadeInUp" data-wow-delay="0.6s">
					...
					<!-- Text -->
					<h5 class="statistic-number"><span class="count-element">85</span></h5>
					<p class="txt-400">Həkimlərimiz</p>
			...
			<div class="col-md-6 col-lg-3">
				<div class="statistic-block icon-sm wow fadeInUp" data-wow-delay="0.8s">
					...
					<!-- Text -->
					<h5 class="statistic-number"><span class="count-element">453</span></h5>
					<p class="txt-400">Xəstəxana otaqları</p>
			...
			<div class="col-md-6 col-lg-3">
				<div class="statistic-block icon-sm wow fadeInUp" data-wow-delay="1s">
					...
					<!-- Text -->
					<h5 class="statistic-number"><span class="count-element">16</span></h5>
					<p class="txt-400">Ailə Sağlamlıq Mərkəzləri</p>
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-6">
								<div class="txt-block pc-30">
									...
									<!-- Button -->
									<a href="#" class="btn btn-blue blue-hover mt-30">View More
										Details</a>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 section-title">
				...
				<!-- Title 	-->
				<h3 class="h3-md steelblue-color">Vətəndaşlar rəyləri</h3>
				...
				<div class="owl-carousel owl-theme reviews-holder">
					...
					<div class="review-2">
						<div class="review-txt text-center">
							...
							<!-- Testimonial Text -->
							<p>An augue cubilia laoreet undo magna at risus suscipit egestas magna an ipsum
								ligula
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 section-title">
				...
				<!-- Title 	-->
				<h3 class="h3-md steelblue-color">Bizim İxtisaslı Həkimlərimiz</h3>
				...
				<div class="doctor-1">
					...
					<div class="hover-overlay text-center">
						...
						<div class="profile-link">
							<a class="btn btn-sm btn-tra-white black-hover" href="#" title="">View
								More Info</a>
						</div>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="all-doctors mb-40">
					<a href="#" class="btn btn-blue blue-hover">Meet All Doctors</a>
				</div>
			</div>
		</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-lg-6 offset-lg-1">
					<div class="banner-txt pc-30 wow fadeInUp" data-wow-delay="0.4s">
						...
						<!-- Section ID -->
						<span class="section-id id-color">Abşeron RMX</span>

						<!-- Title  -->
						<h3 class="h3-lg">Ən Müasir Texnologiya Sizlərin Xidmətinizdə </h3>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 section-title">
				...
				<!-- Title 	-->
				<h3 class="h3-md steelblue-color">Yeniliklər & Xəbərlər</h3>
			...
			<div class="col-lg-4">
				<div class="blog-post wow fadeInUp" data-wow-delay="0.4s">
					...
					<div class="blog-post-txt">
						...
						<!-- Post Title -->
						<h5 class="h5-sm steelblue-color"><a href="#">5 Benefits Of Integrative
								Medicine</a></h5>

						<!-- Post Data -->
						<span>May 03, 2023 by <span>Dr.Jeremy Smith</span></span>

						<!-- Post Text -->
						<p>Quaerat neque purus ipsum neque dolor primis libero tempus impedit tempor blandit
							sapien at
			...
			<div class="col-lg-4">
				<div class="blog-post wow fadeInUp" data-wow-delay="0.6s">
					...
					<div class="blog-post-txt">
						...
						<!-- Post Title -->
						<h5 class="h5-sm steelblue-color"><a href="#">Your Health Is In Your
								Hands</a></h5>

						<!-- Post Data -->
						<span>Apr 28, 2023 by <span>Dr.Jonathan Barnes</span></span>
			...
			<div class="col-lg-4">
				<div class="blog-post wow fadeInUp" data-wow-delay="0.8s">
					...
					<div class="blog-post-txt">
						...
						<!-- Post Title -->
						<h5 class="h5-sm steelblue-color"><a href="#">How Weather Impacts Your
								Health</a></h5>

						<!-- Post Data -->
						<span>Apr 17, 2023 by <span>Dr.Megan Coleman</span></span>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="all-posts-btn mb-40 wow fadeInUp" data-wow-delay="1s">
					<a href="#" class="btn btn-blue blue-hover">Read More Posts</a>
				</div>
			</div>
		</div>
		...
		<div class="row d-flex align-items-center">
			...
			<div class="col-lg-8 offset-lg-2">
				<div class="banner-txt icon-lg text-center">
					...
					<!-- Title  -->
					<h3 class="h3-sm">Əlaqə məlumatları </h3>

					<h4 class="h4-lg">Telefon Nömrəsi</h4>
					<h2 class="h2-lg">(012) 342 26 11</h2>
