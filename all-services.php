				...
				<div id="tabs-nav" class="list-group text-center clearfix">
					<ul class="nav nav-pills" id="pills-tab" role="tablist">
						...
						<li class="nav-item icon-xs">
							<a class="nav-link active" id="tab11-list" data-toggle="pill" href="#tab-11" role="tab"
								aria-controls="tab-11" aria-selected="true">
						...
						<!-- TAB-2 LINK -->
						<li class="nav-item icon-xs">
							<a class="nav-link" id="tab12-list" data-toggle="pill" href="#tab-12" role="tab"
						...
						<!-- TAB-3 LINK -->
						<li class="nav-item icon-xs">
							<a class="nav-link" id="tab13-list" data-toggle="pill" href="#tab-13" role="tab"
								aria-controls="tab-13" aria-selected="false">
								MRI Diagnostic
							</a>
						</li>
						...
						<!-- TAB-4 LINK -->
						<li class="nav-item icon-xs">
							<a class="nav-link" id="tab14-list" data-toggle="pill" href="#tab-14" role="tab"
								aria-controls="tab-14" aria-selected="false">
								X-Ray Diagnostic
							</a>
						</li>
						...
						<div class="row">
							...
							<div class="col-xl-6">
								...
								<div class="box-list">
									...
									<p>Nemo ipsam egestas volute and turpis dolores quaerat massa suscipit, luctus neque
									</p>
								</div>
								...
								<div class="box-list">
									...
									<p>Magna massa suscipit, luctus neque purus and ipsum neque dolor primis luctus
										tempor</p>
								</div>
